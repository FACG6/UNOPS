  ...
  <div className="container">
    <form className="search-sidebar">
      <div className="margin searchbar">
        <input className=" searchform" type="text" placeholder="Search for tickets" />
        <div className="icon-div">
          <i className="fas fa-search" />
        </div>
      </div>
      <label htmlFor="user-select" className="margin label">
        Users:
      </label>
      ...
      <label htmlFor="status-select" className="margin label">
        Status:
      </label>
